...
###############################################################################
def main(flagFiles=None, pipeline='LINC', run_type='calibrator', filtered_antennas='[CR]S*&',
         bad_antennas='[CR]S*&', output_fname=None, structure_file=None,
         Ateam_separation_file=None, solutions=None, clip_sources='',
         demix_sources='', demix=False, removed_bands='', min_unflagged=0.5, refant=''):
	"""
	Creates summary of a given pipeline run
...
if __name__=='__main__':
	...
	main(flagFiles=args.flagFiles, pipeline=args.pipeline, run_type=args.run_type,
         filtered_antennas=args.filtered_antennas, bad_antennas=args.bad_antennas,
